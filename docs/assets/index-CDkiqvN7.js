const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-eYzkHapL.js","assets/HamburgerMenu-HvGsvgbZ.js","assets/BackButton-DPlCGvye.js","assets/DynamicCameraFov-CX8nCism.js","assets/App-BbJ6H6IK.js","assets/AddCameraTarget-CkL1hVCT.js","assets/PoiHandler-6-1RPFYL.js","assets/Helper-OuO6zV8T.js","assets/App-B1DHHdf6.js","assets/App-D1hQcomJ.js","assets/App-C2xutLV8.js"])))=>i.map(i=>d[i]);
...
const ProjectSelector = ({ setSelectedPage }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(List, { sx: { width: "100%", maxWidth: 360, bgcolor: "black", borderRadius: 2 }, children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemButton, { onClick: () => setSelectedPage(project.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemText, { primary: project.name }) }, project.id)) })
  ] });
};
const pages = {
  npgDemo: reactExports.lazy(() => __vitePreload(() => import("./App-eYzkHapL.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)),
  testProject: reactExports.lazy(() => __vitePreload(() => import("./App-BbJ6H6IK.js"), true ? __vite__mapDeps([4,1,5,6,2,7]) : void 0)),
  nammo: reactExports.lazy(() => __vitePreload(() => import("./App-B1DHHdf6.js"), true ? __vite__mapDeps([8,1,5,6,2]) : void 0)),
  scrollDemo: reactExports.lazy(() => __vitePreload(() => import("./App-D1hQcomJ.js"), true ? __vite__mapDeps([9,1,5,3,7]) : void 0)),
  trox: reactExports.lazy(() => __vitePreload(() => import("./App-C2xutLV8.js"), true ? __vite__mapDeps([10,1,5,6,2]) : void 0))
};
let scenePath = null;
let basePath = null;
const Routing = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { textAlign: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { children: "Loading..." }) }),
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageComponent, { setSelectedPage })
    }
  );
};
...
const RedHatDisplayBold = "/3d-web-demos/fonts/RedHatDisplay-Bold.ttf";
        ...
        "@font-face": [
          {
            ...
            fontStyle: "normal",
            fontWeight: 400,
            src: `local('Red Hat Display'), local('RedHatDisplay-Regular'), url(${RedHatDisplay}) format('truetype')`
          },
          {
            fontFamily: "Red Hat Display",
            fontStyle: "normal",
            fontWeight: 600,
            src: `local('Red Hat Display'), local('RedHatDisplay-SemiBold'), url(${RedHatDisplaySemibold}) format('truetype')`
          },
          {
            fontFamily: "Red Hat Display",
            fontStyle: "normal",
            fontWeight: 700,
            src: `local('Red Hat Display'), local('RedHatDisplay-Bold'), url(${RedHatDisplayBold}) format('truetype')`
          }
        ]
      }
    }
...
export {
  ...
  defaultTheme$1 as F,
  _inheritsLoose as G,
  _objectWithoutPropertiesLoose as H,
  TransitionGroupContext as I,
  getOverlayAlpha as J,
  keyframes as K,
  css as L,
  setRef as M,
  useSlot as N,
  ...
  memoTheme as m,
  resolveProps as n,
  createSimplePaletteValueFilter as o,
  alpha as p,
  useTheme$2 as q,
  reactExports as r,
  scenePath as s,
  useEnhancedEffect as t,
  useDefaultProps as u,
  React$1 as v,
  THEME_ID as w,
  requireReactDom as x,
  getDefaultExportFromCjs as y,
  resolveComponentProps as z
};
//# sourceMappingURL=index-CDkiqvN7.js.map
