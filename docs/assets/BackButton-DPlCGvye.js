import { a as generateUtilityClass, g as generateUtilityClasses, r as reactExports, d as styled, i as ButtonBase, k as rootShouldForwardProp, l as capitalize, m as memoTheme, n as resolveProps, u as useDefaultProps, j as jsxRuntimeExports, e as clsx, f as composeClasses, o as createSimplePaletteValueFilter, p as alpha, c as clientExports, B as Box } from "./index-CDkiqvN7.js";
import { ah as useId, ai as CircularProgress, aj as THREE, b as addEffect, ab as applyProps } from "./HamburgerMenu-HvGsvgbZ.js";
...
const BackButton = ({ onClick, children, homeButton }) => {
  reactExports.useEffect(() => {
    ...
    let backButtonContainer = document.getElementById("backButton-container");
    if (!backButtonContainer) {
      backButtonContainer = document.createElement("div");
      backButtonContainer.id = "backButton-container";
      ...
      backButtonContainer.style.flexDirection = "rows";
      backButtonContainer.style.pointerEvents = "none";
      backButtonContainer.style.gap = "1rem";
      uiOverlay.appendChild(backButtonContainer);
    }
    const buttonDiv = document.createElement("div");
    const root = clientExports.createRoot(buttonDiv);
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          sx: {
            position: "relative",
            pointerEvents: "auto",
            // Ensure the button receives clicks
            zIndex: 900
          },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              color: "primary",
              variant: "text",
              id: homeButton ? "home-button" : "back-button",
              style: {
                color: "white",
    ...
    backButtonContainer.appendChild(buttonDiv);
    return () => {
      root.unmount();
      if (backButtonContainer.contains(buttonDiv)) {
        backButtonContainer.removeChild(buttonDiv);
      }
    };
  }, [onClick, children, homeButton]);
  return null;
};
export {
  BackButton as B,
...
//# sourceMappingURL=BackButton-DPlCGvye.js.map
