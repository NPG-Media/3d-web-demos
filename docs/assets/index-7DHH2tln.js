...
let scenePath = null;
const DefaultPage = reactExports.lazy(() => __vitePreload(() => import("./App-B3XjbObB.js"), true ? [] : void 0));
const Routing = () => {
  ...
  const PageComponent = reactExports.lazy(
    () => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./pages/npgDemo/App.tsx": () => __vitePreload(() => import("./App-B3XjbObB.js"), true ? [] : void 0) }), `./pages/${path || "npgDemo"}/App.tsx`, 4).catch(() => DefaultPage)
...
export {
  css as A,
  internal_createExtendSxProp as B,
  createTheme as C,
  resolveProps as D,
  useRtl as E,
  clientExports as F,
  ...
  useDefaultProps as t,
  useInsertionEffectAlwaysWithSyncFallback as u,
  React as v,
  withEmotionCache as w,
  alpha as x,
  getOverlayAlpha as y,
  keyframes as z
};
//# sourceMappingURL=index-7DHH2tln.js.map
